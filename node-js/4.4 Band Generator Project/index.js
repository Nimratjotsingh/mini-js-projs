...
app.post("/submit", (req, res) => {
  var randomnumber1 = Math.floor(Math.random()*noun.length);
  var randomnumber2 = Math.floor(Math.random()*adj.length);
  var random_name = `${adj[randomnumber2]} ${noun[randomnumber1]}`
